...
5. **Prediction is not causation.** Entry/survival probabilities describe patterns in historical transitions. They do not estimate the causal effect of removing a particular constraint.
