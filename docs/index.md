...
## Current build
- v0.1: full HS6 x destination trade/execution pipeline, including out-of-time entry and survival models.
...
## Commercial boundary
The public layer demonstrates provenance and transparent diagnostics. Historical entry/survival probabilities, candidate firm matching, constraint diagnosis, scenario analysis and client-specific execution layers remain private/commissioned.
